 ...
 */
@Controller
@RequestMapping("/biz/ficprod")
public class FinanceProdController extends BaseController{
	...
	public ModelAndView list(HttpServletRequest request,Model model) {
		...
		mv.setViewName("biz/ficprod/ficprod-list");
		return mv;
	}
	...
	public OutputObject getList(@ModelAttribute("financeProdForm") FinanceProdForm financeProdForm,
		...
		//设置查询理财
		financeProdForm.setCategory("finance");
		...
		List<Map<String,Object>> finances=outputObject.getBeans();
		for(Map<String,Object> finance:finances){
			finance.put("articleName",StringUtilLY.replaceHTMLEntity(finance.get("articleName").toString()));
			finance.put("name",StringUtilLY.replaceHTMLEntity(finance.get("name").toString()));
		}
		return outputObject;
	}
	...
	public ModelAndView add() {
		...
		mav.setViewName("biz/ficprod/add-ficprod");
		return mav;
	}
	...
	public ModelAndView view(Model model) {
		...
		String imagePath = (String)finance.get("imagePath");
		...
		mav.setViewName("biz/ficprod/view-ficprod");
		return mav;
	}
	...
	public ModelAndView edit(Model model) {
		...
		model.addAttribute("role", request.getParameter("role"));
		mav.setViewName("biz/ficprod/edit-ficprod");
		return mav;
	}
		...
		try {
			...
			for (Map.Entry<String, MultipartFile> entity : fileMap.entrySet()) {
				...
				File savefile = new File(savePath);
					// 设置文件数据库的物理路径
				String contextPath = request.getContextPath();
					String showImgPath=contextPath+"/viewImage/viewImage?imgPath="+fileName;
